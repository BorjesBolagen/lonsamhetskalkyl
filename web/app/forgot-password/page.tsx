	...
	return (
		...
		>
			<div className="absolute top-8 right-8 bg-white p-3 rounded shadow-lg z-20 flex items-center justify-center">
				<img src="/logo.png" alt="Börjes Logotyp" className="h-10 w-auto object-contain" />
			</div>
			...
			<div className="relative z-10 bg-white p-10 md:p-14 rounded-sm shadow-2xl w-full max-w-md mx-4">
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					{message && <p className="text-sm text-center font-medium text-gray-700">{message}</p>}
					...
					<div className="text-center">
						<Link href="/login" className="text-sm underline hover:text-black transition-colors">
