...
const LINE_TO_CLUSTER: Record<string, string> = {
  ...
  "Linköping - Ljungby (Avd:1440)": "SML-Växjö", // överväg SML-Linköping
  "Linköping-Nybro": "SML-Nybro", // överväg SML-Linköping
  "Ljungby - Linköping": "SML-Växjö", // överväg SML-Ljungby
  "Ljungby - Örebro": "SML-Växjö", // överväg SML-Ljungby
  ...
  "Övrigt": "Ej relevant", // Allt nedan är nya uppdaterade linjer
  ...
  "Diverse Ljungby": "Ej relevant",
  "DSV": "Ej relevant",
  "Eksjö - Ljungby": "Ej relevant",
  "Eksjö - Växjö": "Ej relevant",
  "Eksjö-Örebro": "Ej relevant",
  "Extrabilar": "Ej relevant",
  "Gods Ut": "Ej relevant",
  ...
  "Kunder": "Ej relevant",
  "Köping": "Ej relevant",
  "Lager 157 (Borås)": "Ej relevant",
  "Lenhovda": "Ej relevant",
  ...
  "Ljungby - Jönköping": "SML-Ljungby",
  "Ljungby - Stockholm (Avd:1425)": "SML-Ljungby",
  "Ljungby - Västerås": "SML-Ljungby",
  "MMW-LBY": "Ej relevant",
  "Malmö - Markaryd": "AHL-Skåne",
  "Markaryd - Jönköping": "SML-Ljungby",
  "Markaryd - Linköping": "SML-Ljungby",
